...
class ParseAndSaveSmsUseCase @Inject constructor(
    ...
    private fun parseInternal(sender: String, messageBody: String, timestamp: Long, smsId: String?, matchedCorrection: com.trackfi.data.local.UserCorrectionEntity?): TransactionEntity? {
