...
val PrimarySky = Color(0xFF00D4FF) // Soft Neon Light Blue
val PrimaryContainerSky = Color(0xFF00A3FF)
val SecondaryPink = Color(0xFFFF00FF) // Light Neon Pink
val TertiaryEmerald = Color(0xFF00FF88) // Fresh Light Green
