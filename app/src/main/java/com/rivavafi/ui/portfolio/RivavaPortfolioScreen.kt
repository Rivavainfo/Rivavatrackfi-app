...
import com.rivavafi.ui.components.PortfolioStockCard
import com.rivavafi.ui.theme.PrimaryContainerSky
import com.rivavafi.ui.components.SectionHeader
        ...
        LazyColumn(
            ...
            item {
                ...
                Row(
                    ...
                    androidx.compose.foundation.Image(
                        painter = androidx.compose.ui.res.painterResource(id = com.rivavafi.R.drawable.rivava_logo),
            ...
            groupedPortfolio.forEach { (exchange, items) ->
                item {
                    ...
                    val primaryColor = if (isNyse) com.rivavafi.ui.theme.NyseGold else PrimaryContainerSky
...
@Composable
fun NewsCard(news: com.rivavafi.domain.api.FinnhubNewsResponse) {
    val uriHandler = androidx.compose.ui.platform.LocalUriHandler.current
    Card(
        modifier = Modifier
            .width(260.dp)
...
fun CryptoCard(id: String, data: CryptoData) {
    ...
    val color = if (isPositive) com.rivavafi.ui.theme.EmeraldGreen else com.rivavafi.ui.theme.VibrantRed
    Card(
        modifier = Modifier
            .width(180.dp)
            .clip(RoundedCornerShape(16.dp))
