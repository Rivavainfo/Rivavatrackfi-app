...
import com.rivavafi.ui.portfolio.components.CashBalanceSection
import com.rivavafi.ui.portfolio.components.PortfolioMetricsTable
...
import com.rivavafi.ui.theme.PremiumGradientStart
import com.rivavafi.ui.components.PremiumButton
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            if (ticker == "IREDA" || ticker == "IREDA.NS") {
                com.rivavafi.ui.portfolio.components.IredaInsightsCard()
            }

            if (newsList.isNotEmpty()) {
                com.rivavafi.ui.components.SectionHeader(title = "Company News")
                ...
                if (ticker == "IREDA" || ticker == "RTX") {
                        ...
                        modifier = Modifier
                            ...
                            .background(
                                Brush.linearGradient(
                                    colors = listOf(
                                        if (ticker == "IREDA") com.rivavafi.ui.theme.DeepBlueVariant else com.rivavafi.ui.theme.AmoledBlack,
                                        if (ticker == "IREDA") com.rivavafi.ui.theme.EmeraldGreen.copy(alpha = 0.8f) else com.rivavafi.ui.theme.PrimarySky.copy(alpha = 0.8f)
                                    )
                                )
                            )
                    ) {
                        Column(
                            ...
                            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                                ...
                                Column {
                                    ...
                                    Text(if (ticker == "IREDA") "715%" else "62.8%", color = if (ticker == "IREDA") com.rivavafi.ui.theme.EmeraldGreen else com.rivavafi.ui.theme.PrimarySky, style = MaterialTheme.typography.titleMedium.copy(fontWeight = FontWeight.Bold))
                                }
                            }
                            Spacer(modifier = Modifier.height(16.dp))
                            Button(
                                ...
                                modifier = Modifier.fillMaxWidth(),
                                colors = ButtonDefaults.buttonColors(containerColor = Color.White, contentColor = com.rivavafi.ui.theme.DeepBlueVariant),
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .background(
                                Brush.linearGradient(
                                    colors = listOf(com.rivavafi.ui.theme.LightPink.copy(alpha = 0.7f), com.rivavafi.ui.theme.DeepBlueVariant)
                                )
                            )
                    ) {
                        Row(
                            ...
                            Button(
                                onClick = { },
                                colors = ButtonDefaults.buttonColors(containerColor = Color.White, contentColor = com.rivavafi.ui.theme.LightPink),
                                shape = RoundedCornerShape(12.dp)
                            ) {
