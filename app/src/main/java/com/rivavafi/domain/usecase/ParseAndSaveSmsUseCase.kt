...
class ParseAndSaveSmsUseCase @Inject constructor(
    ...
    private fun parseInternal(sender: String, messageBody: String, timestamp: Long, smsId: String?, matchedCorrection: com.rivavafi.data.local.UserCorrectionEntity?): TransactionEntity? {
